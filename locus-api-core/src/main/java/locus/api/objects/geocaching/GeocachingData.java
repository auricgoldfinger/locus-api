...
public class GeocachingData extends Storable {
	...
	protected void readObject(int version, DataReaderBigEndian dr)
		...
		attributes = (ArrayList<GeocachingAttribute>) 
				dr.readListStorable(GeocachingAttribute.class);
		logs = (ArrayList<GeocachingLog>) 
				dr.readListStorable(GeocachingLog.class);
		trackables = (ArrayList<GeocachingTrackable>) 
				dr.readListStorable(GeocachingTrackable.class);
		waypoints = (ArrayList<GeocachingWaypoint>) 
				dr.readListStorable(GeocachingWaypoint.class);
